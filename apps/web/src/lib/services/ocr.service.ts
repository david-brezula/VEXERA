...
import { createNotificationForAllMembers } from "@/lib/services/notification.service"
 ...
 * Looks for "Dodávateľ:", "Predávajúci:", "Dodavatel:", or the first company-like line.
 */
function extractSupplierName(text: string): string | null {
  // Pattern: "Dodávateľ:" or "Predávajúci:" followed by the company name
 ...
 * Looks for patterns like "Číslo faktúry:", "Fa č.:", "Invoice No:", etc.
 */
...
/**
 * Extract variable symbol (variabilný symbol / VS).
