...
export async function updateDocumentStatusAction(
  ...
  try {
    ...
    const currentStatus = (doc as unknown as { status: DocumentStatus }).status
...
export async function batchApproveDocumentsAction(
  ...
  try {
    ...
    const docs = docsRaw as unknown as Array<{ id: string; status: DocumentStatus }>
...
export async function addDocumentCommentAction(
  ...
  try {
    ...
    const { error } = await (supabase.from("document_comments" as any) as any)
      .insert({
