      ...
      <SheetContent side="right" className="flex w-full flex-col p-0 sm:max-w-md">
        <SheetHeader className="px-4 pt-4 pb-2">
          <div className="flex items-center justify-between">
            <SheetTitle className="text-base">AI Financny asistent</SheetTitle>
            <div className="flex gap-1">
              ...
              <Button variant="ghost" size="icon" onClick={handleNewSession} className="h-8 w-8">
                ...
                <span className="sr-only">Nova konverzacia</span>
              </Button>
            </div>
          </div>
        </SheetHeader>
            ...
            <div className="space-y-1">
              {sessions && sessions.length > 0 ? (
                sessions.map((s) => (
                  ...
                  >
                    <div className="truncate">{s.title ?? "Nova konverzacia"}</div>
